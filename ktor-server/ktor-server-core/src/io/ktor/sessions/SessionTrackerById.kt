 ...
 */
class SessionTrackerById<T : Any>(val type: KClass<T>, val serializer: SessionSerializer<T>, val storage: SessionStorage, val sessionIdProvider: () -> String) : SessionTracker<T> {
